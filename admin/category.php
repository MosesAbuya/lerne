...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="fw-bold text-dark">Blog Categories</h3>
                ...
                <?php if (count($categories) > 0): ?>
                    <?php foreach ($categories as $row): ?>
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="edit_category.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <button type="button" class="btn btn-sm btn-outline-danger ms-2" onclick="deleteRecord(<?= $row['id'] ?>, 'delete_category.php', 'category.php')">
